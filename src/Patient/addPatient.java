...
public class addPatient extends javax.swing.JFrame {
    ...
    private void pDateFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void pIdFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void pNameFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void pAgeFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void pAddressFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void pPhoneFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void pDiseaseFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void pRoomFieldActionPerformed(java.awt.event.ActionEvent evt) {

    }
    private void pGenderFieldActionPerformed(java.awt.event.ActionEvent evt) {

    }
    private void pStatusFieldActionPerformed(java.awt.event.ActionEvent evt) {
