...
public class doctorManagement extends javax.swing.JFrame {
    ...
    private void addReceptionbtn1MouseClicked(java.awt.event.MouseEvent evt) {
        addDoctor aDoctor = new addDoctor();
        aDoctor.setVisible(true);
        dispose();
    }
    private void addReceptionbtn3MouseClicked(java.awt.event.MouseEvent evt) {
        addDoctor aDoctor = new addDoctor();
        aDoctor.setVisible(true);
        dispose();
    }
    private void updateReceptionbtnMouseClicked(java.awt.event.MouseEvent evt) {
        updateDoctor uReceptionist = new updateDoctor();
        uReceptionist.setVisible(true);
        this.dispose();
    }
    private void updateReceptionbtn2MouseClicked(java.awt.event.MouseEvent evt) {
        updateDoctor uReceptionist = new updateDoctor();
        uReceptionist.setVisible(true);
        this.dispose();
    }
    private void deleteReceptionbtnMouseClicked(java.awt.event.MouseEvent evt) {
        deleteDoctor dDoctor = new deleteDoctor();
        dDoctor.setVisible(true);
        this.dispose();
}
    private void deleteReceptionbtn2MouseClicked(java.awt.event.MouseEvent evt)
        {
            deleteDoctor dDoctor = new deleteDoctor();
            dDoctor.setVisible(true);
            this.dispose();
        }
    private void viewReceptionbtnMouseClicked(java.awt.event.MouseEvent evt)
        {
            viewDoctor vReceptionist = new viewDoctor();
            vReceptionist.setVisible(true);
            dispose();
        }
    private void viewReceptionbtn2MouseClicked(java.awt.event.MouseEvent evt)
        {
            viewDoctor vReceptionist = new viewDoctor();
            vReceptionist.setVisible(true);
            dispose();
        }
    private void searchReceptionbtnMouseClicked(java.awt.event.MouseEvent evt)
        {
            searchDoctor sReceptionist = new searchDoctor();
            sReceptionist.setVisible(true);
            dispose();
        }
    private void searchReceptionbtn2MouseClicked(java.awt.event.MouseEvent evt)
        {
            searchDoctor sReceptionist = new searchDoctor();
            sReceptionist.setVisible(true);
            dispose();
