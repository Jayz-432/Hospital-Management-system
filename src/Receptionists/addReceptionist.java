...
public class addReceptionist extends javax.swing.JFrame {
    ...
    private void rDateFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void rIdFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void rNameFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void rAgeFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void rBloodFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void rPhoneFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void rAddressFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void rEmailFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void rGenderFieldActionPerformed(java.awt.event.ActionEvent evt) {

    }
    private void rStatusFieldActionPerformed(java.awt.event.ActionEvent evt) {
